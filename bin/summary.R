...
write.csv(assignment_all, "assignment_all_genetic_and_hash.csv", row.names=FALSE, quote=FALSE)
...
write.csv(classification_all, "classification_all_genetic_and_hash.csv", row.names=FALSE, quote=FALSE)
